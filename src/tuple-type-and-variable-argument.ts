...
const func = (...args: Args): string => args[0]
...
const func2 = (f: string, ...args: Args2): string => args[0]
...
const func4 = (str: string, num: number, b: boolean): string => str + num

const args4: [string, number, boolean] = ['foo', 3, false]
